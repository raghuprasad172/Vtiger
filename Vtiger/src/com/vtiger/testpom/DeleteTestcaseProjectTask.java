...
public class DeleteTestcaseProjectTask extends BaseTest {
	@Test
	...
	driver.findElement(By.xpath("//form[@id='massdelete']/descendant::table[6]/descendant::input[@type='button'][1]")).click();
